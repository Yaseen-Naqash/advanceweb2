"""
Django settings for advanceweb2 project.
...
SECRET_KEY = 'django-insecure-vcmfjj)mc12m%dopqtpdni3_p1rjd@r4&i!0fxr^0wsr&vb^x#'
...
WSGI_APPLICATION = 'advanceweb2.wsgi.application'
